...
<head>
    ...
    <title>Política de Privacidad - Impostor Words</title>
    <style>
...
<body>
    ...
    <p><strong>Última actualización:</strong> 17 de Abril de 2026</p>

    <p>Gracias por jugar a <strong>Impostor Words</strong> ("la Aplicación"). Esta política de privacidad explica cómo recopilamos, usamos y protegemos su información cuando utiliza nuestra aplicación móvil.</p>

    <h2>1. Recopilación y Uso de Datos</h2>
    <p>No recopilamos información personal identificable como nombres, direcciones, números de teléfono o correos electrónicos sin su consentimiento explícito.</p>
    <p>Solo guardamos los paquetes de palabras personalizados vinculados a su identificador de cuenta de Firebase anónimo o cuenta registrada con el fin de proporcionar el servicio multiplataforma.</p>
    ...
    <h2>3. Compras dentro de la aplicación (Google Play Billing)</h2>
    <p>Ofrecemos compras dentro de la aplicación (In-App Purchases) a través de Google Play. Las transacciones se procesan mediante <strong>Google Play Billing</strong>, que puede usar métodos de pago asociadas a su cuenta de Google (incluyendo Google Wallet). No tenemos acceso ni almacenamos los detalles de su tarjeta de crédito.</p>
    ...
    <hr>
    <p style="font-size: 14px; text-align: center; color: #7f8c8d;">Para cualquier duda contacta con el soporte de Impostor Words.</p>
</body>
</html>
  `;
