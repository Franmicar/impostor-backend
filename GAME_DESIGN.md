...
- **Infraestructura Backend**: Funciones Serveless gestionadas con un núcleo de Express en Node.js que alimentan las barajas remotas del juego.
- **Plataforma**: Preparado como Aplicación Web Progresiva (PWA) instalable directamente a la pantalla inicio de dispositivos móviles o para su ejecución paralela de escritorio.
